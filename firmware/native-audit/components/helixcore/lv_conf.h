...
#define LV_DRAW_BUF_STRIDE_ALIGN                1  /* audit: esp_lcd draw_bitmap expects packed rows; 16 is an ARM-SIMD tuning */
...
#define LV_USE_LOG 1
    ...
    *0: User need to register a callback with `lv_log_register_print_cb()`*/
    #define LV_LOG_PRINTF 1  /* audit: LVGL warnings to UART */
...
#define LV_ASSERT_HANDLER_INCLUDE <stdint.h>  /* audit: repo uses include/lvgl_assert_handler.h (app-layer) */
#define LV_ASSERT_HANDLER __builtin_trap();  /* audit: panic with backtrace, not silent halt */
...
#define LV_FONT_MONTSERRAT_14 1  /* audit: built-in default font */
...
#define LV_USE_SYSMON   1 /*AUDIT: Task 5 FPS gate — perf overlay for eyeball check*/
#if LV_USE_SYSMON
    ...
    #define LV_USE_PERF_MONITOR 1 /*AUDIT: Task 5 FPS gate*/
