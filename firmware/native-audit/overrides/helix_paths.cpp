...
// AUDIT OVERRIDE: newlib has no statvfs; report generous free space so the
// portable path utilities (ensure_dir, strip_trailing_slash, resolve chains)
// stay REAL. A Phase 2 port swaps in esp_littlefs_info().
#ifndef ESP_PLATFORM
...
#ifdef ESP_PLATFORM // AUDIT OVERRIDE
    (void)dir;
