...
([`mk/tests.mk:415`](../../../mk/tests.mk#L415)) builds **only** `helix-tests`; `make test-run` ([`mk/tests.mk:418`](../../../mk/tests.mk#L418)) builds it and
...
4. [`mk/tests.mk:415`](../../../mk/tests.mk#L415) — the `test` (build-only) vs `test-run` (parallel shards) split, and the `~[.] ~[slow]` filter convention.
