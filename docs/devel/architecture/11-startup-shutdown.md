...
7. [`src/application/application.cpp:3597`](../../../src/application/application.cpp#L3597) — `connect_moonraker()`: when it connects, what Safe Mode skips, where `start_auto_send` lands.
