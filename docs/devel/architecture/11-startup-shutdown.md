...
10. [`src/application/application.cpp:5004`](../../../src/application/application.cpp#L5004) — `shutdown()`: walk the ladder against the "How it works" list; the long comments at `:5173` and `:5208` are the two UAF post-mortems.
