...
6. **`ObserverGuard::invalidate_all()`** ([`src/application/application.cpp:5252`](../../../src/application/application.cpp#L5252)), then destroy MoonrakerManager, stop the HttpExecutors, `m_display.reset()` → `DisplayManager::shutdown()` which runs **`lv_deinit()` then `lv_xml_deinit()`** ([`src/application/display_manager.cpp:703`](../../../src/application/display_manager.cpp#L703)), and finally `theme_manager_deinit()` dead last ([`src/application/application.cpp:5294`](../../../src/application/application.cpp#L5294)).
...
4. [`src/application/application.cpp:1606`](../../../src/application/application.cpp#L1606) — `init_theme()`: note [`globals.xml`](../../../ui_xml/globals.xml) registered *before* `theme_manager_init()` and why.
...
8. [`src/application/application.cpp:1969`](../../../src/application/application.cpp#L1969) — `init_ui()`: the timed `lv_xml_create`, navbar wiring, `PanelFactory` handoff.
