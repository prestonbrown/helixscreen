...
6. [`src/application/subject_initializer.cpp:231`](../../../src/application/subject_initializer.cpp#L231) — `init_core_and_state()`: the dependency phases, and the NavigationManager-registers-last comment.
