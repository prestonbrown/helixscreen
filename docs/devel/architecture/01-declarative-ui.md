...
- `<event_cb ... callback="on_temp_graph_preset_clicked"/>` resolves the name against C++ registrations — here the startup table in [`src/xml_registration.cpp#register_xml_components`](../../../src/xml_registration.cpp#L591):
  ...
  The handler at [`src/ui/ui_overlay_temp_graph.cpp#on_temp_graph_preset_clicked`](../../../src/ui/ui_overlay_temp_graph.cpp#L716) receives the click with the button's user data.
