...
18. [`include/ui_modal.h:96`](../../../include/ui_modal.h#L96) — `Modal`: static `show()` at `:101` vs instance `show()` at `:147`, the pure virtuals at `:185`, `ModalStack` at `:298`, helpers at `:463`.
