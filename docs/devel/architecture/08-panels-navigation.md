...
18. [`include/ui_modal.h:97`](../../../include/ui_modal.h#L97) — `Modal`: static `show()` at `:101` vs instance `show()` at `:147`, the pure virtuals at `:185`, `ModalStack` at `:298`, helpers at `:463`.
19. [`include/ui_info_qr_modal.h:11`](../../../include/ui_info_qr_modal.h#L11) — the 42-line subclass; then [`src/ui/ui_info_qr_modal.cpp#show_modal`](../../../src/ui/ui_info_qr_modal.cpp#L13) for `show_modal()`, `on_show()` wiring, and the self-deleting `on_hide()` at `:30`.
