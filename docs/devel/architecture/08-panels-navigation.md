...
17. [`src/ui/ui_panel_print_status.cpp:1305`](../../../src/ui/ui_panel_print_status.cpp#L1305) — persistent registration, third argument `true`: the one overlay family that survives navbar switches.
