...
17. [`src/ui/ui_panel_print_status.cpp:1374`](../../../src/ui/ui_panel_print_status.cpp#L1374) — persistent registration, third argument `true`: the one overlay family that survives navbar switches.
