...
8. [`src/api/moonraker_discovery_sequence.cpp:1139`](../../../src/api/moonraker_discovery_sequence.cpp#L1139) — `build_subscription_objects()`: the narrowed field lists and the comments explaining why (100 Hz motion objects, fork-only fields). The subscribe call and initial-snapshot handling at `:1536`.
