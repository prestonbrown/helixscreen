...
5. [`src/ui/ui_overlay_network_settings.cpp:683`](../../../src/ui/ui_overlay_network_settings.cpp#L683) — the text/visibility archetype (three sites within ten lines); first project #2 starts here.
