...
6. [`src/ui/panel_widgets/fan_stack_widget.cpp:688`](../../../src/ui/panel_widgets/fan_stack_widget.cpp#L688) — `bind_fan_observer()`: the manual subject read that works around the deferred initial fire under populate's freeze.
