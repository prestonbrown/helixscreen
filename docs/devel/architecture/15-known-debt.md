...
2. [`scripts/quality-checks.sh:1583`](../../../scripts/quality-checks.sh#L1583) — where the baseline 379 is enforced and how a port ratchets it down.
