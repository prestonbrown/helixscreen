...
6. [`src/ui/panel_widgets/fan_stack_widget.cpp:684`](../../../src/ui/panel_widgets/fan_stack_widget.cpp#L684) — `bind_fan_observer()`: the manual subject read that works around the deferred initial fire under populate's freeze.
