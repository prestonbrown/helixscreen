...
2. [`scripts/quality-checks.sh:1603`](../../../scripts/quality-checks.sh#L1603) — where the baseline 370 is enforced and how a port ratchets it down.
