...
(verbatim from [`src/printer/printer_state.cpp:667`](../../../src/printer/printer_state.cpp#L667)). `set_klippy_state()` (`:659`) uses the `helix::async::call_method()` flavor — same queue, less ceremony. Chapter 02 dissects both.
