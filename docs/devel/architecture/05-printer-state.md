...
5. [`include/tool_state.h#ToolState`](../../../include/tool_state.h#L91) — ToolState: the five subjects, `ToolTopology` override (`include/tool_state.h#ToolTopology`), `extruder_count()` vs `tool_count()` (`include/tool_state.h#ToolState/tool_count`), and `get_subjects_lifetime()` (`include/tool_state.h#get_subjects_lifetime`) with its death-signal contract.
6. [`include/temperature_controller.h#TemperatureController`](../../../include/temperature_controller.h#L65) — the controller: `resolved_name()`, `keypad_range()`, `SendOptions` (`include/temperature_controller.h#SendOptions`), and `set_target()` (`include/temperature_controller.h#"set_target(HeaterType type,"`) — the one send.
