...
11. [`src/ui/ui_panel_print_status.cpp:1091`](../../../src/ui/ui_panel_print_status.cpp#L1091) — the precedence chain applied; then the pinned-mode guard at `:346`.
