...
2. [`src/ui/ui_gcode_viewer.cpp:1510`](../../../src/ui/ui_gcode_viewer.cpp#L1510) — Phase 0: the streaming decision in five lines, then the two paths diverging at [`src/ui/ui_gcode_viewer.cpp:1579`](../../../src/ui/ui_gcode_viewer.cpp#L1579) (streaming) and [`src/ui/ui_gcode_viewer.cpp:1729`](../../../src/ui/ui_gcode_viewer.cpp#L1729) (full-load).
