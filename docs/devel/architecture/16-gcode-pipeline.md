...
8. [`src/ui/ui_print_select_detail_view.cpp:1728`](../../../src/ui/ui_print_select_detail_view.cpp#L1728) — `start_tail_summary_scan()`: the local-vs-HTTP tail read, pure parse off the main thread, stale-file guard, and the need-dependent fall-through.
9. [`include/tools_used_cache.h:20`](../../../include/tools_used_cache.h#L20) — the cache: keying, LRU bound, and the "empty set is legitimate" contract at `:24`. Then its three call sites in the detail view ([`src/ui/ui_print_select_detail_view.cpp:455`](../../../src/ui/ui_print_select_detail_view.cpp#L455), [`src/ui/ui_print_select_detail_view.cpp:1253`](../../../src/ui/ui_print_select_detail_view.cpp#L1253), [`src/ui/ui_print_select_detail_view.cpp:1631`](../../../src/ui/ui_print_select_detail_view.cpp#L1631)).
