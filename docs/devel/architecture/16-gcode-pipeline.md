...
11. [`src/ui/ui_panel_print_status.cpp:1069`](../../../src/ui/ui_panel_print_status.cpp#L1069) — the precedence chain applied; then the pinned-mode guard at `:346`.
