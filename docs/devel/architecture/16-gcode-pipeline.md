...
4. [`include/gcode_streaming_controller.h#"class GCodeStreamingController {"`](../../../include/gcode_streaming_controller.h#L169) — the controller: cache budget floor, prefetch radius, and `try_get_layer_segments()`'s shared_ptr contract at `:294`.
...
11. [`src/ui/ui_panel_print_status.cpp#on_activate`](../../../src/ui/ui_panel_print_status.cpp#L1116) — the precedence chain applied; then the pinned-mode guard at `:346`.
