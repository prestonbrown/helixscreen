...
8. [`src/ui/ui_print_select_detail_view.cpp:1744`](../../../src/ui/ui_print_select_detail_view.cpp#L1744) — `start_tail_summary_scan()`: the local-vs-HTTP tail read, pure parse off the main thread, stale-file guard, and the need-dependent fall-through.
9. [`include/tools_used_cache.h:20`](../../../include/tools_used_cache.h#L20) — the cache: keying, LRU bound, and the "empty set is legitimate" contract at `:24`. Then its three call sites in the detail view ([`src/ui/ui_print_select_detail_view.cpp:456`](../../../src/ui/ui_print_select_detail_view.cpp#L456), [`src/ui/ui_print_select_detail_view.cpp:1254`](../../../src/ui/ui_print_select_detail_view.cpp#L1254), [`src/ui/ui_print_select_detail_view.cpp:1643`](../../../src/ui/ui_print_select_detail_view.cpp#L1643)).
