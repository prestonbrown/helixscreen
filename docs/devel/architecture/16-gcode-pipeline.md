...
8. [`src/ui/ui_print_select_detail_view.cpp:1863`](../../../src/ui/ui_print_select_detail_view.cpp#L1863) — `start_tail_summary_scan()`: the local-vs-HTTP tail read, pure parse off the main thread, stale-file guard, and the need-dependent fall-through.
9. [`include/tools_used_cache.h:20`](../../../include/tools_used_cache.h#L20) — the cache: keying, LRU bound, and the "empty set is legitimate" contract at `:24`. Then its three call sites in the detail view ([`src/ui/ui_print_select_detail_view.cpp:489`](../../../src/ui/ui_print_select_detail_view.cpp#L489), [`src/ui/ui_print_select_detail_view.cpp:1415`](../../../src/ui/ui_print_select_detail_view.cpp#L1415), [`src/ui/ui_print_select_detail_view.cpp:1766`](../../../src/ui/ui_print_select_detail_view.cpp#L1766)).
