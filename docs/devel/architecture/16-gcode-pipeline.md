...
6. [`src/ui/ui_print_select_detail_view.cpp:600`](../../../src/ui/ui_print_select_detail_view.cpp#L600) — `local_gcode_source()`: the same-host probe and size staleness check; then `reclaim_download()` at `:619` for the delete gate.
