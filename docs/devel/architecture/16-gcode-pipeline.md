...
2. [`src/ui/ui_gcode_viewer.cpp:1516`](../../../src/ui/ui_gcode_viewer.cpp#L1516) — Phase 0: the streaming decision in five lines, then the two paths diverging at [`src/ui/ui_gcode_viewer.cpp:1585`](../../../src/ui/ui_gcode_viewer.cpp#L1585) (streaming) and [`src/ui/ui_gcode_viewer.cpp:1740`](../../../src/ui/ui_gcode_viewer.cpp#L1740) (full-load).
...
13. [`src/ui/ui_gcode_viewer.cpp:877`](../../../src/ui/ui_gcode_viewer.cpp#L877) — the long-press constant and its comment; then the release callback's tap handling at `:1083`.
