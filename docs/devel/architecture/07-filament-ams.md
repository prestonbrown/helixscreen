...
9. [`include/ams_state.h:1633`](../../../include/ams_state.h#L1633) — `BackendSlotSubjects` and its lifetime-token comment; glance at the storage members at `:1558`-1560 (mutex, `backends_`, `secondary_slot_subjects_`).
