...
8. [`include/printer_capabilities_state.h:354`](../../../include/printer_capabilities_state.h#L354) — all 22 subjects in one block; then `set_hardware()`'s contract at `:58` and the `AsyncLifetimeGuard` comment at `:328`.
