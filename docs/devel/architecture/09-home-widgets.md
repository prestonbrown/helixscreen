...
- `on_size_changed(colspan, rowspan, width_px, height_px)` — adapt content to the cell; called by the manager right after every `attach()` ([`panel_widget_manager.cpp:940`](../../../src/ui/panel_widget_manager.cpp#L940)), including on reused instances.
