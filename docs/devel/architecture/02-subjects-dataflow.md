...
10. [`src/application/subject_initializer.cpp:297`](../../../src/application/subject_initializer.cpp#L297) — `init_core_subjects()` and the phase comments; skim the ordering rationale (navigation after PrinterState, observers last).
