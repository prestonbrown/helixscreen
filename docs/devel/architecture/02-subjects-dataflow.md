...
2. [`src/application/application.cpp:4167`](../../../src/application/application.cpp#L4167) — the main-loop strip from `check_timeouts()` through `process_notifications()` (`:4107`) to `lv_timer_handler()` (`:4136`). This is the ordering the mermaid diagram encodes.
