...
11. [`src/application/application.cpp:2184`](../../../src/application/application.cpp#L2184) — `init_plugins()`: owned manager, service injection, the error toast with Disable action.
