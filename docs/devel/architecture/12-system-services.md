...
11. [`src/application/application.cpp:2172`](../../../src/application/application.cpp#L2172) — `init_plugins()`: owned manager, service injection, the error toast with Disable action.
