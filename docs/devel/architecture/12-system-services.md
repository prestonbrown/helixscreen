...
| `PrintHistoryManager` | Application-owned ([`application.cpp:2103`](../../../src/application/application.cpp#L2103)), published as nullable pointer ([`app_globals.h:116`](../../../include/app_globals.h#L116)) | no | no (client callbacks) | none |
...
| `PluginManager` | Application-owned `unique_ptr` ([`application.cpp:2144`](../../../src/application/application.cpp#L2144)) — **not** `::instance()` | no | plugins may spawn their own | [`../PLUGIN_DEVELOPMENT.md`](../PLUGIN_DEVELOPMENT.md) |
...
2. [`src/system/update_checker.cpp:1249`](../../../src/system/update_checker.cpp#L1249) — the print-guard block and its telemetry report; then `:1315` for the re-entry guard and `:1341` where `download_thread_` spawns.
...
11. [`src/application/application.cpp:2141`](../../../src/application/application.cpp#L2141) — `init_plugins()`: owned manager, service injection, the error toast with Disable action.
