...
9. [`src/ui/theme_manager.cpp:2056`](../../../src/ui/theme_manager.cpp#L2056) — `theme_manager_apply_theme()`: the whole live-switch sequence from swap maps to generation bump.
