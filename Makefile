...
# GLM (3D math library for G-code preview)
GLM_DIR := glm
GLM_INC := -I$(GLM_DIR)

# STB (image writing library for G-code preview)
STB_INC := -Istb

# Include paths
INCLUDES := -I. -I$(INC_DIR) $(LVGL_INC) $(LIBHV_INC) $(SPDLOG_INC) $(WPA_INC) $(SDL2_INC) $(GLM_INC) $(STB_INC)
